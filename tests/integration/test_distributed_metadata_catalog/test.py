    ...
    (
       {
          ...
          "columns" : [ { "name" : "col_1", "type" : "Int32", "default" : "1", "compression_codec" : "ZSTD" }, { "name" : "col_2", "type" : "Float32", "nullable" : False }, { "name" : "col_3", "type" : "DateTime", "nullable" : False, "default" : "now()", "compression_codec" : "ZSTD" }, { "name" : "col_4", "type" : "String", "skipping_index_expression": "INDEX a (col_1 * col_2, col_4) TYPE minmax GRANULARITY 3" }],
