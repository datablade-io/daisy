                ...
                stage('static analyzer') {
                    steps {
                        dir("build_static_analyzer") {
                            sh "NINJA_FLAGS=-k0 cmake .. -DCMAKE_BUILD_TYPE=Debug -DCMAKE_C_COMPILER=/usr/bin/clang-12 -DCMAKE_CXX_COMPILER=/usr/bin/clang++-12 -DENABLE_CLANG_TIDY=1 -DWITH_COVERAGE=ON"
